...
<head>
    ...
    <title>PASS College AI Assistant</title>
...
<body>
    ...
    <div id="chat-widget">
        <div id="chat-bubble" class="chat-bubble">
            <img src="../IMG ASSETS/passlogo.png" alt="PASS Logo" class="chat-logo">
        ...
        <div id="chat-modal" class="chat-modal">
            <div class="chat-header">
                <div class="chat-header-info">
                    <img src="../IMG ASSETS/passlogo.png" alt="PASS Logo" class="chat-header-logo">
                    <div>
