...
$activeAnnouncements = get_active_clinic_announcements('students');
    ...
    <div class="page-shell">
        <aside class="side-nav">
            ...
            <div class="nav-section">
                <h3>Services</h3>
                <a href="student_home.php"><span class="nav-icon"><i class="fa-solid fa-home"></i></span>Dashboard</a>
                <a href="student_clinic.php" class="active"><span class="nav-icon"><i class="fa-solid fa-stethoscope"></i></span>Clinic</a>
                <a href="student_library.php"><span class="nav-icon"><i class="fa-solid fa-book"></i></span>Library</a>
                <a href="student_guidance.php"><span class="nav-icon"><i class="fa-solid fa-user-graduate"></i></span>Guidance</a>
                <a href="student_ssc.php"><span class="nav-icon"><i class="fa-solid fa-award"></i></span>SSC/Scholarship</a>
                <a href="student_ssaa.php"><span class="nav-icon"><i class="fa-solid fa-users"></i></span>SSAA</a>
            </div>
            ...
            <header class="topbar">
                ...
                <div class="topbar-right">
                    <div class="user-info">
                        ...
                        <span class="user-meta"><?= htmlspecialchars($user['course'] ?? 'Course') ?> · <?= htmlspecialchars($user['year_level'] ?? 'Year') ?></span>
                    </div>
                        ...
                        <div class="tab-content">
                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="emergency_contact_relationship" name="emergency_contact_relationship" value="<?= htmlspecialchars($userHealthRecord['emergency_contact_relationship'] ?? '') ?>" placeholder="e.g., Parent, Guardian">
                                            </div>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div id="clearance-request" class="tab-panel">
                                <div class="tab-header">
                                    ...
                                    <p>Request medical clearance for internships, sports, or employment</p>
                                </div>
                                <div class="tab-body">
